  ...
  <div>
    ...
    <div v-else>
      ...
      <div class="promptPaneAction">
        ...
        <prompt-pane-action-budget v-else-if="prompt.type === 'budget'" :options="prompt.options" :budget="prompt.budget" @next-prompt="onNextPrompt"></prompt-pane-action-budget>
...
import PromptPaneActionBudget from '~/components/PromptPaneActionRating.vue'
