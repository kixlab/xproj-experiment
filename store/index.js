...
const store = () => new Vuex.Store({
  ...
  state: {
    ...
    articles: [
      ...
      {
        title: `실업·집값에 결혼 외면하는 청년들…비혼·만혼 '역대급'`,
        content: `지난해 평균 초혼연령이 어김없이 상승한 가운데 인구 1000명당 혼인건수는 역대 최저치를 기록했다. 높은 청년실업률과 부동산 가격에 신음하는 청년들이 결혼을 늦추거나 포기하면서 혼인율 지표가 추락하는 모습이다.
        ...
        출처: http://news.naver.com/main/read.nhn?mode=LSD&mid=sec&sid1=102&oid=003&aid=0008498255`
      },
      {
    ...
    promises: [
      ...
      {
        title: '안심주택 8만호 공급(2018년)',
        goals: ['공공임대주택 6만호, 민간임대주택 2만호 공급'],
        plans: [
          '건설형(1.7만호), 매입형(1.5만호), 임차형(2.8만호) 공공임대주택 공급',
          '준공공임대(1만호) 활성화, 민간임대 공공성 강화(1.3만호)',
          '[공공주택 건설 및 공급 등에 관한 조례] 제정을 통한 절차 간소화',
          '[공공주택, 주거복지 페스티벌] 개최를 통한 임대주택 인식 개선',
          '수요자 맞춤형 임대주택 공급으로 입주민 만족도 증가 및 삶의 질 향상'
        ],
        links: [
          {
            title:
              '“전월세 보증금 지원 받으세요“...서울시 장기안심주택 500호 공급',
            link: 'http://www.ajunews.com/view/20171001131043286'
          },
          {
            title: `장기안심주택, 3가지 과제 풀어야 수급 안심`,
            link: `http://www.asiae.co.kr/news/view.htm?idxno=2017121510382562902`
          },
          {
            title: `2018년도 장기안심주택 공급 추진계획`,
            link: `https://opengov.seoul.go.kr/sanction/14171730?from=policy&tid=8188`
          }
        ],
        pros: ['주거 안정성 확대', '전세/집값 안정'],
        cons: [
          '집주인 및 중개인을 위한 인센티브가 부족',
          '지원금 규모가 집을 구할 수 없을 정도로 비현실적'
        ],
        choices: [''],
        budget: 29976.6
      },
      ...
      {
        title: '<안심귀가 스카우트> 확대 운영',
        goals: ['여성과 청소년들의 안전한 귀가 지원을 통해 여성이 안전한 서울 조성'],
        plans: [
           '여성 등 범죄 취약계층 안전귀가 지원, 안전 취약지역 순찰 및 홍보',
          '주 5일, 14시간(월요일 2시간, 화~금요일 3시간 근무), 월 687,960원(교통비 포함) 지급',
          '25개 자치구, 443명 활동 중'
        ],
        links: [
                    {
             title: `[기자가 해봤습니다]안심귀가서비스 사용해보니... 스카우트와 한밤 귀갓길 ‘든든’`,
             link: `http://theleader.mt.co.kr/articleView.html?no=2017092811127822999`
           },
           {
             title: `변죽만 울리는 핑크빛 정책들`,
             link: `http://www.hankookilbo.com/v/3b7696a6a9704263ac9ad7e5c2756d71`
           },
           {
             title: `2018년 안심귀가 스카우트 추진계획`,
             link: `https://opengov.seoul.go.kr/sanction/14401256`
           }
        ],
        pros: [
          '범죄취약계층의 안전한 귀가 지원',
          '스카우트 고용을 통한 공공 일자리 창출'
        ],
        cons: [
          '이용 절차가 번거로움',
          '스카우트 근무자 부족',
      ...
      {
        title: '대중음악 전문 공연장 건립',
        goals: ['문화기반이 열악한 동북권에 대규모 공연이 가능한 <대중음악전문공연장> 건립'],
        plans: [
          '2만석 규모의 서울아레나 건립',
          '연계 숙박시설, 음악, 공연 생태계 조성',
          '민간투자를 우선으로 하여 협상 및 협약 체결 후 공사 착공'
        ],
        links: [
          {
            title: `2만석 규모 <서울 아레나> 2021년 창동에`,
            link: `http://news.khan.co.kr/kh_news/khan_art_view.html?artid=201510281116121`
          },
          {
            title: `도봉구, ‘서울아레나' 정부와 갈등설 진화 부심`,
            link: `http://www.ohmynews.com/NWS_Web/View/at_pg.aspx?CNTN_CD=A0002127557`
          },
          {
            title: `(2018) 서울아레나 복합문화시설 민간투자사업`,
            link: `https://opengov.seoul.go.kr/budget/14606522`
          }
        ],
        pros: [
          '서울 동북권 지역의 문화 수요 충족',
          '문화 인프라 확충을 통한 지역(창동, 상계) 이미지 상승',
          '서울의 대중음악산업 선도를 위한 발판 마련'
        ],
        cons: [
          '올림픽경기장 등 기존 대중음악 시설이 충분히 시민의 문화 수요를 충족하고 있음',
          '상동, 창계 지역에만 유리한 정책공약임'
        ],
        choices: [
          ''
        ],
  ...
  mutations: {
    ...
    setExpCondition: function (state, payload) {
      state.expCondition = payload.expCondition
    }
    // ...firebaseMutations
  },
  // actions: {
